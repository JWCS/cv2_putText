...
const auto fancy_fmt = cv::putTextFancy(
    fancy::kBlue, 4, true, fancy::kGreen, false, 6, // blue shadow, green bg
...
cv::putTextFancy(
    cv::InputOutputArray /* cv::Mat */ img, cv::Point origin,
    std::optional<cv::Scalar> outlineColor, int outlineThickness = 4, bool shadow = false,
    std::optional<cv::Scalar> bgColor = std::nullopt, bool bgFilled = true, int bgPadding = 6,
    cv::Scalar color = fancy::kWhite, int thickness = 2,
    double fontScale = 1.0, double lineSpacing = 1.1,
